export default function Favoritosdeusuario() {
    const ListaTarjetas = [{id:0, img:"Lava.png", nombre: "Granja Lava", desc:"Granja que usa la mecanica de las estalagtitas para generar lava dentro de calderos...",creador: "Usuario x"},
        ...
        <div className="min-h-screen flex flex-col items-center py-10">
            <div className="w-[95%] mx-auto">
                ...
                <div className="flex items-center justify-between mb-10">
                    ...
                    <h1 className="text-white text-3xl">Favoritos de Willyrex</h1>
                    </div>
